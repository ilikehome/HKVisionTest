...
playM4dllpath_dict = {'windows64': os.path.dirname(__file__) + '\\lib\\win\\' + 'PlayCtrl.dll',
                      'windows32': os.path.dirname(__file__) + '\\lib\\win\\' + 'PlayCtrl.dll',
                      'linux64': os.path.dirname(__file__) + '/lib/armlinux/libPlayCtrl.so',
                      'linux32': os.path.dirname(__file__) + '/lib/armlinux/libPlayCtrl.so'}
