...
netsdkdllpath_dict = {'windows64': os.path.dirname(__file__) + '\\lib\\win\\' + 'HCNetSDK.dll',
                      'windows32': os.path.dirname(__file__) + '\\lib\\win\\' + 'HCNetSDK.dll',
                      'linux64': os.path.dirname(__file__) + '/lib/armlinux/libhcnetsdk.so',
                      'linux32': os.path.dirname(__file__) + '/lib/armlinux/libhcnetsdk.so'}
